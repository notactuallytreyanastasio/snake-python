...
from builtins import str as str4, int as int0, bool as bool19, list as list8, len as len11
from temper_core import cast_by_type as cast_by_type57, date_to_string as date_to_string74, date_from_iso_string as date_from_iso_string75, arith_int_mod as arith_int_mod76, int_to_string as int_to_string14, string_get as string_get12, string_next as string_next15, string_count_between as string_count_between77, int_sub as int_sub25
from typing import Sequence as Sequence22
...
int_to_string_2629 = int_to_string14
len_2630 = len11
string_get_2631 = string_get12
string_next_2633 = string_next15
string_count_between_2634 = string_count_between77
int_sub_2635 = int_sub25
...
days_in_month_34: 'Sequence22[int0]' = (0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)
def is_leap_year_32(year_41: 'int0') -> 'bool19':
    return_21: 'bool19'
    t_263: 'int0'
    if arith_int_mod_2628(year_41, 4) == 0:
        ...
        return_21 = False
    return return_21
def pad_to_33(min_width_43: 'int0', num_44: 'int0', sb_45: 'list8[str4]') -> 'None':
...
day_of_week_lookup_table_leapy_35: 'Sequence22[int0]' = (0, 0, 3, 4, 0, 2, 5, 0, 3, 6, 1, 4, 6)
day_of_week_lookup_table_not_leapy_36: 'Sequence22[int0]' = (0, 0, 3, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5)
