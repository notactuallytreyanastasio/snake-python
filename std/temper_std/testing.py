from builtins import bool as bool19, str as str4, Exception as Exception23, int as int0, list as list8, tuple as tuple6, len as len11
from typing import MutableSequence as MutableSequence20, Callable as Callable21, Sequence as Sequence22, Union as Union3
from temper_core import Pair as Pair9, Label as Label24, list_join as list_join7, list_map as list_map10, string_get as string_get12, str_cat as str_cat13, int_to_string as int_to_string14, string_next as string_next15, int_add as int_add16, listed_reduce_from as listed_reduce_from17, list_get as list_get18
tuple_2526 = tuple6
list_join_2528 = list_join7
list_2529 = list8
pair_2530 = Pair9
list_map_2531 = list_map10
len_2533 = len11
string_get_2534 = string_get12
str_cat_2535 = str_cat13
int_to_string_2536 = int_to_string14
string_next_2539 = string_next15
int_add_2541 = int_add16
listed_reduce_from_2542 = listed_reduce_from17
list_get_2543 = list_get18
class Test:
    failed_on_assert_65: 'bool19'
    passing_66: 'bool19'
    messages_67: 'MutableSequence20[str4]'
    __slots__ = ('failed_on_assert_65', 'passing_66', 'messages_67')
    def assert_(this_13, success_43: 'bool19', message_44: 'Callable21[[], str4]') -> 'None':
        t_406: 'str4'
        if not success_43:
            this_13.passing_66 = False
            t_406 = message_44()
            this_13.messages_67.append(t_406)
    def assert_hard(this_14, success_47: 'bool19', message_48: 'Callable21[[], str4]') -> 'None':
    ...
    @property
    def passing(this_17) -> 'bool19':
        return this_17.passing_66
    def messages(this_18) -> 'Sequence22[str4]':
    ...
    @property
    def failed_on_assert(this_19) -> 'bool19':
        return this_19.failed_on_assert_65
    @property
    def has_unhandled_fail(this_20) -> 'bool19':
        t_264: 'bool19'
    ...
    def __init__(this_25) -> None:
        ...
        t_398: 'MutableSequence20[str4]' = list_2529()
        this_25.messages_67 = t_398
def process_test_cases(test_cases_69: 'Sequence22[(Pair9[str4, (Callable21[[Test], None])])]') -> 'Sequence22[(Pair9[str4, (Sequence22[str4])])]':
    def fn_395(test_case_71: 'Pair9[str4, (Callable21[[Test], None])]') -> 'Pair9[str4, (Sequence22[str4])]':
        t_390: 'bool19'
        t_393: 'Sequence22[str4]'
        t_246: 'bool19'
        t_248: 'bool19'
        key_73: 'str4' = test_case_71.key
        fun_74: 'Callable21[[Test], None]' = test_case_71.value
        test_75: 'Test' = Test()
        had_bubble_76: 'bool19' = False
        try:
            fun_74(test_75)
        except Exception23:
            had_bubble_76 = True
        messages_77: 'Sequence22[str4]' = test_75.messages()
        failures_78: 'Sequence22[str4]'
        if test_75.passing:
        ...
        if t_246:
            ...
            if had_bubble_76:
                ...
                t_248 = False
            if t_248:
                all_messages_79: 'MutableSequence20[str4]' = list_2529(messages_77)
...
def escape_xml_41(s_103: 'str4') -> 'str4':
    ...
    return return_40
def report_test_results(test_results_80: 'Sequence22[(Pair9[str4, (Sequence22[str4])])]', write_line_81: 'Callable21[[str4], None]') -> 'None':
    t_360: 'int0'
    t_363: 'str4'
    t_369: 'str4'
    write_line_81('<testsuites>')
    total_83: 'str4' = int_to_string_2536(len_2533(test_results_80))
    def fn_352(fails_85: 'int0', test_result_86: 'Pair9[str4, (Sequence22[str4])]') -> 'int0':
        t_203: 'int0'
    ...
    while True:
        ...
        if not i_89 < t_360:
            break
        test_result_90: 'Pair9[str4, (Sequence22[str4])]' = list_get_2543(test_results_80, i_89)
        failure_messages_91: 'Sequence22[str4]' = test_result_90.value
    ...
    write_line_81('</testsuites>')
def run_test_cases(test_cases_96: 'Sequence22[(Pair9[str4, (Callable21[[Test], None])])]') -> 'str4':
    report_98: 'list8[str4]' = ['']
    t_345: 'Sequence22[(Pair9[str4, (Sequence22[str4])])]' = process_test_cases(test_cases_96)
    def fn_343(line_99: 'str4') -> 'None':
        report_98.append(line_99)
        report_98.append('\n')
    report_test_results(t_345, fn_343)
    return ''.join(report_98)
def run_test(test_fun_100: 'Callable21[[Test], None]') -> 'None':
    test_102: 'Test' = Test()
    try:
