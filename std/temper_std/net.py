...
class NetRequest:
    ...
    url_17: 'str4'
    method_18: 'str4'
    body_content_19: 'Union3[str4, None]'
    body_mime_type_20: 'Union3[str4, None]'
    __slots__ = ('url_17', 'method_18', 'body_content_19', 'body_mime_type_20')
    def post(this_0, content_22: 'str4', mime_type_23: 'str4') -> 'None':
        ...
        t_50: 'Union3[str4, None]' = this_0.body_mime_type_20
        this_0.body_mime_type_20 = t_50
    def send(this_1) -> 'Future2[NetResponse]':
        ...
        return std_net_send_2599(this_1.url_17, this_1.method_18, this_1.body_content_19, this_1.body_mime_type_20)
    def __init__(this_5, url_28: 'str4') -> None:
...
class NetResponse(metaclass = ABCMeta50):
    ...
    @property
    @abstractmethod52
    def content_type(self) -> 'Union3[str4, None]':
        pass
    @property
    @abstractmethod52
    def body_content(self) -> 'Future2[(Union3[str4, None])]':
        pass
def send_request_16(url_35: 'str4', method_36: 'str4', body_content_37: 'Union3[str4, None]', body_mime_type_38: 'Union3[str4, None]') -> 'Future2[NetResponse]':
    raise RuntimeError1()
